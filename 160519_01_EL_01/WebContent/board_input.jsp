...
<script type="text/javascript">
	function w_accept(c) {
		...
		form1.pds_link_temp.value = form1.pds_link.value;
		if (c == "mod") {			
...
<body>
	<form action="write.do" name="board_form" method="post" enctype="multipart/form-data">
		<table border="1">
			<tr>
				<th>글제목</th>
				<th>작성자</th>
			...
			<tr>
				...
				<input type="file" name="pds_link">				
				    <c:if test="${BDTO ne null}">${BDTO.pds_link}</c:if>
					<input type="hidden" name="pds_link_temp">
				</td>
			</tr>
			<tr>
				<th>본문 내용</th>
