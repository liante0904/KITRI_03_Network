	...
	<tr>
		<td colspan="5">		
			<c:choose>
				...
				<c:otherwise><a href="read.do?p_code=download&p_bid=${BDTO.board_id}&pds_value=${BDTO.pds_link_temp}">${BDTO.pds_link}</a></c:otherwise>
			</c:choose>
		</td>		
	</tr>
	<tr>
...
<p><input type="button" value="목록보기" onclick="javascript:history.go(-1)"> </p>
